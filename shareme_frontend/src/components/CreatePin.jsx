            ...
            <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
                        ...
                        {!imageAsset ? (
                            ...
                            <div className="relative h-full">
                                ...
                                <button type="button" onClick={() => setImageAsset(null)}
                                        className="absolute bottom-3 right-3 p-3 rounded-full bg-white cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out">
                                    <MdDelete />
                                </button>
                            </div>
                        )}
                ...
                <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
                    <input
                        ...
                        className="outine-none text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2"
                    />
                    {user && (
                    ...
                    <input
                        ...
                        className="outine-none text-base sm:text-lg border-b-2 border-gray-200 p-2"
                    />
                    <input
                        type="text"
                        value={destination}
