    ...
    return (
        <div className="m-2">
            ...
            <Link to={`/user-profile/${postedBy?._id}`} className="flex gap-2 mt-2 items-center">
                <img className="w-8 h-8 rounded-full object-cover" src={postedBy?.image} alt="user-image" />
                <p className="font-titillium text-lg text-bold capitalize">{postedBy?.userName}</p>
            </Link>
        </div>
    )
}
